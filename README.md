...
In case of failure of loading Jupyter Notebooks on Github, the following notebooks can be found in the repository. Click on the respective links to view:
...
- Tableau - This Business Intelligence tool was required to explore data and create charts, graphs, and visualizations to come up with a Sales Dashboard for Customer Segmentation for the automobile bike company.

## Built With
- Python 3.8.2, Tableau

## Maintainer
- Manmohan S. - [LinkedIn Profile](https://www.linkedin.com/in/manmohan-sangola/)
- Email: manmohansangola1@gmail.com

## About the Developer
Manmohan S. is a Supply Chain Analyst with over 4 years of experience in inventory planning, logistics coordination, and supply chain analytics. He specializes in analyzing operational KPIs and inventory movement using SQL, Python, and Power BI to drive visibility and process improvement in high-volume business environments.

*Original project concept and initial development by Abhishek Chowdhury.*